...
public class WaitsDemo {
	...
	/*
	 * Waits: sometimes it may happen that web driver is trying to access an element
	 * and the element is not loaded/visible on the page yet
	 * 
	 * so we need to slow down or wait till the element is loaded/visible
	 * Page load timeout Waits for the page to load
	 * 
	 * Thread.sleep
	 * 
	 ...
	 * Implicit wait 10 seconds: 10, 7, 2
	 * 
	 * Fluent wait
	 * 
